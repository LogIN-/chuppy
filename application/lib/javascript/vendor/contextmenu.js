...
;(function($){
    $.contextMenu = {
        ...
        createIframe: function() {
            return $('<iframe class="contextMenuItem" frameborder="0" tabindex="-1" src="javascript:false" style="display:block;position:absolute;z-index:-1;filter:Alpha(Opacity=0);"/>');
        },
        ...
        createMenu: function(menu,cmenu) {
            ...
            var $t = $('<table class="contextMenuItem" cellspacing="0" cellpadding="0"></table>').click(function(){cmenu.removeAll(); return false;}); // We wrap a table around it so width can be flexible
            var $tr = $('<tr></tr>');
            var $td = $('<td></td>');
            var $div = $('<div class="contextMenuItem '+className+'"></div>');
        ...
        createMenuItem: function(label,obj) {
            ...
            var $div = $('<div class="contextMenuItem '+cmenu.itemClassName+' '+o.className+((o.disabled)?' '+cmenu.disabledItemClassName:'')+'" title="'+o.title+'"></div>')
            ...
            var $idiv = $('<div class="contextMenuItem '+cmenu.innerDivClassName+'" style="'+iconStyle+'">'+label+'</div>');
            $div.append($idiv);
            return $div;
        },
        ...
        createSeparator: function() {
            return $('<div class="contextMenuItem '+this.separatorClassName+'"></div>');
        },
        ...
        createShadow: function(cmenu) {
            cmenu.shadowObj = $('<div class="contextMenuItem '+cmenu.shadowClass+'"></div>').css( {display:'none',position:"absolute", zIndex:9998, opacity:cmenu.shadowOpacity, backgroundColor:cmenu.shadowColor } );
        ...
        removeAll: function() {
            console.log("Removing all menus");
            $('.contextMenuItem').each(function() {
                $(this).remove();
            });
        }
    };
    ...
    $.fn.contextMenu = function(menu,options, e) {
        $.contextMenu.create(menu,options).show(this, e);
    };
})(jQuery);
